...
namespace UnityEditor.UI
{
    ...
    public class ScrollRectEditor : Editor
    {
        ...
        void SetAnimBools(bool instant)
        {
            ...
            SetAnimBool(m_ShowDecelerationRate, !m_Inertia.hasMultipleDifferentValues && m_Inertia.boolValue == true,
                instant);
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            {
                EditorGUI.indentLevel++;
                EditorGUILayout.PropertyField(m_HorizontalScrollbarVisibility,
            ...
            {
                EditorGUI.indentLevel++;
                EditorGUILayout.PropertyField(m_VerticalScrollbarVisibility,
                    EditorGUIUtility.TrTextContent("Visibility"));
